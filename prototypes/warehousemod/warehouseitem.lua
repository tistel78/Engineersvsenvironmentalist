...
data:extend({
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/warehouse-basic.png",
		icon_size = 32,
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/warehouse-passive-provider.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/warehouse-storage.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
		subgroup = "logistic-network",
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/warehouse-active-provider.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
		subgroup = "logistic-network",
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/warehouse-requester.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
		subgroup = "logistic-network",
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/storehouse-basic.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
		subgroup = "storage",
		order = "d[items]-b[steel-chest]",
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/storehouse-passive-provider.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
		subgroup = "logistic-network",
		order = "b[storage]-c[logistic-chest-passive-provider]",
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/storehouse-storage.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
		subgroup = "logistic-network",
		order = "b[storage]-c[logistic-chest-storage]",
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/storehouse-active-provider.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
		subgroup = "logistic-network",
		order = "b[storage]-c[logistic-chest-active-provider]",
	...
	},
	{
		...
		icon = "__Engineersvsenvironmentalist__/graphics/icons/storehouse-requester.png",
		icon_size = 32,
		flags = {"goes-to-quickbar"},
		subgroup = "logistic-network",
		order = "b[storage]-c[logistic-chest-requester]",
